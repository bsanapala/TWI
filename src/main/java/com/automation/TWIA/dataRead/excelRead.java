package com.automation.TWIA.dataRead;
...
public class excelRead {
	...
	public static String setCellData1(String sheetName, String colName, int rowNum,
			String data) {
		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);
	...
	public static void main(String arg[]) throws IOException {
		...
		datatable = new excelRead(System.getProperty("user.dir") + "//src//Regression_Store.xlsx.xlsx");
	...
	public String setCellData_to_exel(String sheetName, String colName, int rowNum,
			String data, String url) {
		// System.out.println("setCellData setCellData******************");
		try {
			fis = new FileInputStream(path);
	...
	public static String getCellData(String sheetName, String coloumnName, int rowNum){
		...
		try {
			...
			for(int i=0; i<row.getLastCellNum(); i++) {
				if(row.getCell(i).getStringCellValue().equals(coloumnName)) {
